...
using set_request_tuple = std::tuple<  //
    std::string, std::string, std::int64_t, std::string, std::int64_t>;
...
auto AddKvsApi(FluentBuilder f) {
  ...
  return std::move(f)
      .template channel<string, string, std::int64_t, string, std::int64_t>(
      ...
      .template channel<string, std::int64_t, std::int64_t>(
